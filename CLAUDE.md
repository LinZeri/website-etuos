...
1. **PROIBIDO usar travessão "—"** em qualquer texto e em qualquer idioma: código, docs, conteúdo do site, artigos do blog, commits. Use vírgula, dois pontos, parênteses ou reescreva a frase. Antes de finalizar qualquer entrega, confira que não há "—" nos arquivos criados.
