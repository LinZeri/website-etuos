import type { ConteudoLp } from "../lp-seo/pt";

// Copy da landing de campanha de tráfego pago em português (língua fonte).
// Mesma forma da landing de SEO.
export const lpTrafegoPagoPt = {
  metaTitulo: "Plano de ação de tráfego pago em 48 horas",
  metaDescricao:
  ...
  hero: {
    ...
    descricao:
      "Em 48 horas você recebe um plano mostrando onde investir, quanto investir e o que esperar de retorno. Sem custo e sem compromisso.",
    provas: [
      "Análise da sua conta de anúncios, se você já tiver uma",
      "Onde está o seu público e quanto custa falar com ele",
      "Feito por quem já gerenciou mais de meio milhão de dólares em anúncios",
    ],
  },
  formulario: {
    titulo: "Peça o seu plano de ação",
    descricao: "Preencha e receba em até 48 horas, direto no seu WhatsApp.",
    botao: "Quero meu plano de ação",
  },
  plano: {
    eyebrow: "O que você recebe",
    titulo: "O que vem no plano de ação",
    descricao:
      "Não é proposta comercial disfarçada. É o mapa de onde colocar o seu dinheiro e do que ele deve trazer de volta.",
    itens: [
      {
  ...
  passosTitulo: "Do pedido ao plano em 48 horas",
  passos: [
    {
  ...
  quemFaz:
    "Sou publicitário, trabalho com marketing digital há mais de 10 anos e já gerenciei mais de meio milhão de dólares em anúncios. Ajudei uma rede de energia solar a sair de 30 para mais de 300 franquias em 1 ano e 8 meses, e vi clientes crescerem mais de 300% em faturamento. Quem vai olhar a sua conta sou eu, não um estagiário com um modelo pronto.",
  perguntas: [
    {
  ...
  cta: {
    ...
    descricao:
      "O plano é gratuito, sai em 48 horas e mostra onde o seu dinheiro deveria estar. O que você faz com ele é decisão sua.",
  },
} satisfies ConteudoLp;
